...
select p.payment_type_name,sum(f.fare_amount) as total_revenue from practical-mason-430618-d1.uber_data_engineering_project.fact_table f
...
-- Find the average fare amount
select avg(fare_amount) as average_fare_amount from practical-mason-430618-d1.uber_data_engineering_project.fact_table;
